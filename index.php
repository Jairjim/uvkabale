...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light azul scrolling-navbar fixed-top">
        <div class="container">
            ...
            <button class="navbar-toggler bt" type="button" data-toggle="collapse" data-target="#navbarScroll"
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarScroll">
                <ul class="navbar-nav navbar-nav-scroll pull-right" style="max-height: 100px;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link contact" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                            aria-controls="offcanvasRight"> Contáctanos </a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container-fluid justify-content-center gap-5 container-tweet">
                <div class="card" style="width: 18rem;">
                    <div class="card-body card-tweet">
                        <a class="twitter-timeline" href="https://twitter.com/AduanasMx?s=20&t=G2ZBb7qmLqSwt-fsXEw1Lg"
                            data-tweet-limit="1" data-width="399"></a>
                        <script async src="http://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                </div>
                <div class="card" style="width: 18rem;">
                    <div class="card-body card-tweet">
                        <a class="twitter-timeline" href="https://twitter.com/SNICEmx" data-tweet-limit="1"
                            data-width="399"></a>
                        <script async src="http://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                </div>
                <div class="card" style="width: 18rem;">
                    <div class="card-body card-tweet">
                        <a class="twitter-timeline" href="https://twitter.com/SATMX" data-tweet-limit="1"
                            data-width="399"></a>
                        <script async src="http://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
                </div>
    ...
    <div class="container-fluid cabecera">
        ...
        <div class="row about">
            Kabale es un organismo integrado por profesionales con más de 20 años de experiencia en Comercio Exterior,
            donde además de evaluar Normatividad Nacional e Internacional en más de 8 sectores productivos, asistimos a
            los fabricantes nacionales e importadores
            que requieren evaluar la conformidad de sus productos contra las Normas Oficiales Mexicanas de información
            comercial...
        </div>
    ...
    <div class="container-fluid servicios">
        ...
        <div class="row about">
            Contamos con los recursos humanos y materiales para atender los requerimientos de nuestros clientes,
            reduciendo tiempos y los trabajos en el proceso de Evaluación.<br> Además, tenemos la aprobación por parte
            de la Autoridad, para evaluar en
    ...
    <div class="share-btn-container">
        <a href="http://www.linkedin.com/in/unidad-de-inspecci%C3%B3n-kabale-s-a-de-c-v-7b915a234" target="_blank"
            class="linkedin-btn"><i class="fab fa-linkedin"></i></a>
        <a href="https://www.instagram.com/uikabale/" class="instagram-btn" target="_blank"><i
    ...
    <div class="offcanvas offcanvas-end bg-dark" tabindex="-1" id="offcanvasRight"
        ...
        <p class="text-white text-center"> Puedes comunicarte con nosotros al
            <a target="_blank" href="https://wa.me/message/ECFFKO55QMCEG1">55 3245 9292</a> o bien llenar el siguiente
            formulario y uno de nuestros operadores se pondrá encontacto contigo en breve
        </p>
            ...
            <div class="formulario ">
                ...
                <div class="modal-body ">
                    <form action="" method="post">
                        ...
                        <br>
                        <div class="form-floating form-control-sm mb-3 ">
                            <input name="tel" type="tel " class="form-control " placeholder="tel " maxlength="10"
                                required>
    ...
    <footer class="text-center text-white " style="background-color: #f1f1f1; ">
        <div class="container pt-4 ">
            <section class="mb-4 ">
                <!-- Redes Sociales -->
                <a class="btn btn-link btn-floating btn-lg text-dark m-1 " href="https://wa.me/message/ECFFKO55QMCEG1"
                ...
                <a class="btn btn-link btn-floating btn-lg text-dark m-1 " href="https://www.instagram.com/uikabale/ "
                    role="button " data-mdb-ripple-color="dark ">
                    <i class="bi bi-instagram "></i>
                </a>
                <a class="btn btn-link btn-floating btn-lg text-dark m-1 "
                    href="http://www.linkedin.com/in/unidad-de-inspecci%C3%B3n-kabale-s-a-de-c-v-7b915a234 "
                    role="button " data-mdb-ripple-color="dark ">
                    <i class="bi bi-linkedin "></i>
                </a>
                <a class="btn btn-link btn-floating btn-lg text-dark m-1 "
                    href="https://www.facebook.com/profile.php?id=100079046550116" role="button "
                    data-mdb-ripple-color="dark ">
